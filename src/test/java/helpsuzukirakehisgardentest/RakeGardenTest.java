package helpsuzukirakehisgardentest;

import helpsuzukirakehisgarden.RakeGarden;
...
public class RakeGardenTest {
    ...
    public void testRakeGarden(String garden, String expectedOutput){
        assertEquals(expectedOutput, RakeGarden.rakeGarden(garden));
    }
}
